        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <div className="space-y-1">
            ...
            <div className="flex gap-2">
              <select value={filterClass} onChange={(e) => setFilterClass(e.target.value)} className="w-1/2 px-3 py-2.5 border border-slate-300 rounded-xl text-sm">
                <option value="">All class</option>
                <option value={className}>{className}</option>
              </select>
              <select value={filterSection} onChange={(e) => setFilterSection(e.target.value)} className="w-1/2 px-3 py-2.5 border border-slate-300 rounded-xl text-sm">
